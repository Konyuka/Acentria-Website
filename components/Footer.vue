...
<template>
    <div>
        ...
        <footer class="bg-black" aria-labelledby="footer-heading">
            ...
            <div class="mx-auto max-w-[80vw] px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                <div class="flex justify-between">
                    <img class="h-40" src="/img/logo.png" alt="Company name">

                    <div class="relative mt-16 grid grid-cols-2 gap-8 xl:col-span-1 xl:mt-0">
                ...
                <div
                    ...
                    <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
                        ...
                        <input type="email" name="email-address" id="email-address" autocomplete="email" required
                            class="w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-2 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-primary sm:w-56 sm:text-sm sm:leading-6"
                ...
                <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
                    ...
                    <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; {{ currentYear }} Acentria
